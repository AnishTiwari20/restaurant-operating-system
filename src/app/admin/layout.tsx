...
import { LayoutDashboard, Store, LogOut, User as UserIcon } from 'lucide-react';
...
export default async function AdminDashboardLayout({ children }: Props) {
  // 1. Authenticate superadmin session
      ...
      <aside className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-slate-200/80 flex flex-col justify-between shrink-0">
        <div className="flex flex-col">
          ...
          <div className="p-6 border-b border-slate-200/80 flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-black text-slate-900 truncate">RestaurantOS</h2>
